...
propertyDetailsrouter.get('/getPropertyDetailsById/:id', PropertyController.getPropertyDetailsById); // Get All Properties
propertyDetailsrouter.put('/updatePropertyStatus/:propertyId', PropertyController.updatePropertyStatus); // update property status
