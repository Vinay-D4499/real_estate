  ...
  return (
    <div className="p-4 border-t flex items-center space-x-2 bg-white">
      ...
      <input
        ...
        id="mediaUpload"
      />
      <label htmlFor="mediaUpload" className="bg-gray-200 text-gray-700 px-4 py-2 rounded-full cursor-pointer hover:bg-gray-300 transition">
        {mediaFile ? "Media Selected" : "Attach Media"}
      </label>
      <button
        onClick={handleSend}
        disabled={isSending}
        className={`bg-blue-500 text-white px-4 py-2 rounded-full hover:bg-blue-600 transition ${isSending ? "opacity-50 cursor-not-allowed" : ""}`}
      >
